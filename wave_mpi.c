...
double *update ( int id, int p, int NPOINTS, int n_local, int TPOINTS, 
  double dt );
void collect ( int id, int p, int NPOINTS, int n_local, int TPOINTS, 
...
/*
  ...
  Local parameters:
    ...
    Local, int NPOINTS, the total number of points.

    Local, int N_LOCAL, the number of points visible to this process.

    Local, int TPOINTS, the number of time steps.
...
/*
  Determine N_LOCAL.
*/
  i_global_lo = (   id       * ( NPOINTS - 1 ) ) / p;
  i_global_hi = ( ( id + 1 ) * ( NPOINTS - 1 ) ) / p;
  if ( 0 < id )
  {
...
*/
  u1_local = update ( id, p, NPOINTS, n_local, TPOINTS, dt );
/* 
  Collect local values into global array.
*/
  collect ( id, p, NPOINTS, n_local, TPOINTS, dt, u1_local );
/*
...
/*
  ...
  Parameters:
    ...
    Input, int NPOINTS, the total number of points.
...
/*
  The global array of NPOINTS points must be divided up among the processes.
...
*/
  ...
  {
    x = ( double ) ( i_global ) / ( double ) ( NPOINTS - 1 );
...
*/
    u_global = ( double * ) malloc ( NPOINTS * sizeof ( double ) );
/*
...
*/
      ...
      else if ( NPOINTS <= i_global_lo + n_local2 - 1 )
      {
...
*/
    ...
    printf ( "\n" );
    for ( i_global = 0; i_global < NPOINTS; i_global++) 
    {
      x = ( double ) ( i_global ) / ( double ) ( NPOINTS - 1 );
